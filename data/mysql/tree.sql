...
--
-- Host: localhost
-- Generation Time: Jul 03, 2012 at 09:29 AM
...
(1, 0, 0, 1, 14, 0, NULL, NULL),
(2, 1, 0, 2, 11, 1, 'C:', 'drive'),
(3, 1, 1, 12, 13, 1, 'D:', 'drive'),
(4, 2, 0, 3, 6, 2, '_demo', 'folder'),
(5, 2, 1, 7, 10, 2, '_docs', 'folder'),
(6, 4, 0, 4, 5, 3, 'index.html', 'default'),
(7, 5, 0, 8, 9, 3, 'doc.html', 'default');
